---
name: feature-list-table
description: Mandatory architecture, code organization, state management, and design patterns for building feature list tables in the web app, based on the canonical user-list-table implementation.
---
