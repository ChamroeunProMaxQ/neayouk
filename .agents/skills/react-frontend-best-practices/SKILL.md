...
- `ui-tanstack-table-primitives` - Always use TanStack Table (v8) with shadcn UI primitive components, `useUrlFilters` schema sync, debounced search, infinite scroll, and `@repo/contracts` integration for feature list tables
