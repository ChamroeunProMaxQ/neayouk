...
export class CreateClassTimetableDto extends createZodDto(CreateClassTimetableSchema) {}
export class UpdateClassTimetableDto extends createZodDto(UpdateClassTimetableSchema) {}
export class FindClassTimetablesDto extends createZodDto(FindClassTimetablesSchema) {}
